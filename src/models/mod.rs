...
const CREATE_TABLE_ARTICLES_SQL: &str = "CREATE TABLE IF NOT EXISTS articles (
...
const CREATE_TABLE_TAGS_SQL: &str = "CREATE TABLE IF NOT EXISTS tags (
    `id` INT AUTO_INCREMENT PRIMARY KEY,
...
const CREATE_TABLE_PAGES_SQL: &str = "CREATE TABLE IF NOT EXISTS pages (
    `id` INT AUTO_INCREMENT PRIMARY KEY,
    `title` TEXT NOT NULL,
    `content` TEXT NOT NULL,
    `created_at` DATETIME DEFAULT CURRENT_TIMESTAMP,
...
const CREATE_TABLE_USERS_SQL: &str = "CREATE TABLE IF NOT EXISTS users (
    `id` INT AUTO_INCREMENT PRIMARY KEY,
